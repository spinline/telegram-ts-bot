...
function runTests() {
    ...
    try {
        const otp = (0, verificationManager_1.generateOTP)();
    ...
    try {
        ...
        const code = (0, verificationManager_1.createVerificationSession)(testUserId);
    ...
    try {
        ...
        const code = (0, verificationManager_1.createVerificationSession)(testUserId);
        const result = (0, verificationManager_1.verifyOTP)(testUserId, code);
        if (result.success && (0, verificationManager_1.isUserVerified)(testUserId)) {
        ...
        (0, verificationManager_1.removeUserVerification)(testUserId);
    }
    catch (error) {
        console.log(`❌ FAIL - ${error}`);
        failedTests++;
    ...
    try {
        ...
        (0, verificationManager_1.createVerificationSession)(testUserId);
        const result = (0, verificationManager_1.verifyOTP)(testUserId, '000000');
        if (!result.success && !(0, verificationManager_1.isUserVerified)(testUserId)) {
    ...
    try {
        ...
        (0, verificationManager_1.verifyOTP)(testUserId, '111111');
        (0, verificationManager_1.verifyOTP)(testUserId, '222222');
        const result = (0, verificationManager_1.verifyOTP)(testUserId, '333333');
        if (!result.success && (0, verificationManager_1.isUserLockedOut)(testUserId)) {
            const lockoutTime = (0, verificationManager_1.getRemainingLockoutTime)(testUserId);
    ...
    try {
        ...
        (0, verificationManager_1.verifyOTP)(testUserId, '111111');
        (0, verificationManager_1.verifyOTP)(testUserId, '222222');
        (0, verificationManager_1.verifyOTP)(testUserId, '333333');
    ...
    try {
        ...
        const result = (0, verificationManager_1.verifyOTP)(testUserId, '123456');
